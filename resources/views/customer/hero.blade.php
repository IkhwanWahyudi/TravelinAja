<div class="absolute top-[40%] left-[6%] p-20 rounded-lg bg-[#ffffff42] flex flex-col"> {{-- bg-[#ffffff85] --}}
...
<img src="{{ asset('assets/images/home.jpg') }}" alt="" class="w-full h-screen object-cover -z-10">
