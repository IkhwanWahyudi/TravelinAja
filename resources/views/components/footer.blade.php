<footer class="h-auto bg-[#6FBAC3F0] flex justify-center text-slate-600 w-full">
    <div class="container py-8 flex justify-around">
        <div class="self-center">
            <img src="{{ asset('assets/images/logo.png') }}" alt="Logo Shoes.co" class="w-52">
        </div>

        <div class="flex flex-col gap-1">
            <h5 class="text-white font-medium pb-2">Other Pages</h5>
            <a href="#"
                class="p-2 mr-16 rounded-lg text-white hover:bg-white hover:text-[#6FBAC3F0] transition ease-in">Home</a>
            <a href="#"
                class="p-2 mr-16 rounded-lg text-white hover:bg-white hover:text-[#6FBAC3F0] transition ease-in">Buy</a>
        </div>

        <div class="flex flex-col gap-1">
            <h5 class="text-white font-medium pb-2">Contact</h5>
            <a href="mailto:ikhwanw06@gmail.com"
                class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-white transition ease-in">
                <svg class="fill-white group-hover:fill-[#6FBAC3F0] transition ease-in"
                ...
                <p class="text-white group-hover:text-[#6FBAC3F0] transition ease-in">travelinaja@gmail.com</p>
            </a>
            <a href=""
                class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-white hover:text-[#6FBAC3F0] transition ease-in">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                    class="fill-white group-hover:fill-[#6FBAC3F0] transition ease-in">
                    <path
                ...
                <p class="text-white group-hover:text-[#6FBAC3F0] transition ease-in">+62 800 9000 7000</p>
            </a>
        </div>
...
<p class="p-4 bg-white text-center text-[#6FBAC3F0] w-full">© 2023 TravelinAja</p>
