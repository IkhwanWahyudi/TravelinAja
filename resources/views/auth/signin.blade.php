...
@section('content')
    <div class="w-screen h-screen flex flex-row">
        <div class="h-full w-1/2">
            <img src="{{ asset('assets/images/signin.jpeg') }}" alt="" class="h-full w-full">
        </div>
        <div class="h-full w-1/2 flex flex-col justify-around text-center bg-white">
            <a href="" class="flex justify-center">
                <img src="{{ asset('assets/images/logo.png') }}" alt="" class="w-[100px]">
            </a>
            <form action="{{ route('signin.action') }}" method="post" class="w-full flex flex-col items-center">
                ...
                <div class="w-[350px] relative">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                        <svg class="h-6 fill-[#F68712]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                            <path
